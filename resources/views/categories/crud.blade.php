...
<div align="right">
 ...
 <span class="fa fa-plus-circle">AJOUTER UNE CATEGORIE</span></a>
</div>
<table class="table table-bordered table-striped bg-secondary" style="color:white; border:none">
 ...
 <tbody style="color:black; font:blod; background:#ffff">
  <tr class="text-center">
   <td><img src="{{ URL::to('/') }}/images/{{ $mes_articles->image }}"  width="90" height="90" /></td>
   <td>{{ $mes_articles->designation_cat }}</td>
   <td width="25%">
