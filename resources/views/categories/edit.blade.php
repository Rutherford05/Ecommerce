...
<div class="container">
<br>
<h2 class="alert alert-success " > Modification de la catégorie {{$data->designation_cat}} </h2>
</div>
<div class="container">
...
<form>
  <div class="form-row">
    <div class="form-group col-md-6">
      <input mdbInput type="text" class="form-control" name="designation_cat" id="nom" value="{{ $data->designation_cat }}" placeholder="Nom">
    </div>
    <div class="row">
    <div class="form-group col-md-4">
        <input type="file" name="image_cat" id="image" class="form-control">
        </div>
